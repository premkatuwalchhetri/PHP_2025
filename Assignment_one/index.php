...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand" href="view.php">Student Records</a>
    </div>
  </nav>
      ...
      <div class="col-md-6">
        ...
        <form action="add.php" method="POST">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="studentName" name="name" placeholder="" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="studentID" name="student_id" placeholder="" required>
          </div>
          <div class="mb-3">
